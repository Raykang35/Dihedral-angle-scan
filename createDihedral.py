...
### Create 2 planes for the dihedral angle calculation ###
    ...
    # Maybe we will get the number like 1.00000000002, that's the floating-point arithmetic imprecision in computers
    tolerance = 1e-10 
...
def check(D1, D2, D3, D4, N_non):
    ...
    print(f"Successfully created {angle} degree structure")
...
def toPoscar(name,xyzFile,cellParam):
    # Export xyz to POSCAR 
    # cellParam: Cell parameters, please type in as a list
